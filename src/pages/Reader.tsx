...
export default function Reader() {
  ...
  const [notifTab, setNotifTab] = useState<'all' | 'pending' | 'approved' | 'rejected'>('all');
  ...
  return (
    <div className="min-h-screen bg-amber-50 flex flex-col">
      ...
      <UnlockModal
        ...
        onRequested={() => {
          const targetChapter = pendingChapter || currentChapterId;
          setShowUnlockModal(false);
          navigate(`/read/${bookId}/chapter/${targetChapter}`);
          setPendingChapter(null);
        }}
        hasPendingRequest={!!pendingRequest}
        requestStatus={pendingRequest?.status || rejectedRequest?.status}
      />
